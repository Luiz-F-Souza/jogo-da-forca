...
class Forca {
  ...
  //   .replace(/[úuÚ]/g,'U')
  //   .replace(/[çÇ]/g,'C')
  //    console.log(wordToClean)
  //   return wordToClean.toLowerCase()
  // }
  ...
  chutar(letra) { 
    //verificação se condiz com a palavra ou não
    ...
    if(letra.length != 1) return console.log('Jogada inválida. Por favor, digite 01 letra') // testa se há mais ou menos de 01 letra na jogada, se sim, sai do chute sem alterar nenhum estado.


    // testa se a letra já foi usada antes, se sim, sai do chute sem alterar estados. se não adiciona a letra na array letrasChutadas
